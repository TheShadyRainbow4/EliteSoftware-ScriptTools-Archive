...
## Opti-Link Instant Messenger: An AI Chat Client for LM Studio with Theming (v0.9.0.0)
...
1.  **Download:** Download the `v0.9.0.0 OptiLink Instant Messenger.PS1` script file.
...
*   **Settings (`File > Settings`):** Customize application icon, send message hotkey, backend preference (LM Studio is primary in this version), and **theme preference**.
